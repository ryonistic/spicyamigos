 ...
 <section className="relative bg-white overflow-hidden">
  <div className="py-20 md:py-28">
    <div className="container px-4 mx-auto">
        ...
        <div className="w-full md:w-1/2 px-4 mb-16 md:mb-0">
          ...
          <div className="flex flex-wrap">
            <div className="w-full md:w-auto py-1 md:py-0 md:mr-4">
              <Link href="/login">
              <a className="inline-block py-5 px-7 w-full text-base md:text-lg leading-4 font-medium text-center focus:ring-opacity-50 border border-red-500 rounded-md shadow-sm bg-red-600 text-white hover:bg-red-800">Book a table</a>
              </Link>
              </div>
     ...
     <div className="grid place-items-center p-2 m-2 animate-bounce" >
   <Image src="/images/downarrow.svg" alt="Picture of arrow" width={70} 
      height={50} /></div>
 </div>
              )
              }
